...
To use these stylesheets, rename the files and privacymap with the name of your theme.
...
privacymap-alpha-default-narrow.css  
...
privacymap-alpha-default-normal.css
...
privacymap-alpha-default-wide.css
